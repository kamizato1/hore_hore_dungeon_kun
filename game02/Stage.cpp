...
{
	char stage_data[3][50] = { "data/stage/stage011.txt", "data/stage/stage012.txt","data/stage/stage013.txt" };
	char treasure_data[3][50] = { "data/stage/treasure011.txt", "data/stage/treasure012.txt","data/stage/treasure013.txt" };
